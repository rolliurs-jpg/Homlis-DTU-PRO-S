...
choice = MsgBox("Installer ou mettre a jour Boite noire Hoymiles 7.0.49 ?" & vbCrLf & vbCrLf & "Les historiques et les reglages deja presents seront conserves.", vbOKCancel + vbQuestion, "Confirmer l'installation")
