...
const nodes=new Map();
function element(id){if(!nodes.has(id))nodes.set(id,{style:{},textContent:'',innerHTML:'',className:'',clientWidth:360,clientHeight:210,
...
setImmediate(()=>{
 ...
 console.log('5 mobile alarm scenarios passed');
});
