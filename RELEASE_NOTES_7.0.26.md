# Boîte noire Hoymiles v7.0.26

## Graphique plus lisible

- Les mesures sont regroupées par source de données.
- La production PV et le Linky/Dinky utilisent le même bleu ciel.
- Les deux mesures Shelly, production et réseau EDF, utilisent le même violet.
