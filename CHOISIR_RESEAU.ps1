...
$form.ClientSize = New-Object System.Drawing.Size(710, 325)
...
$hint.Text = "Windows propose deux installations. Le Dinky et le Shelly restent sur le Wi-Fi de la box."
$hint.Location = New-Object System.Drawing.Point(27, 53)
$hint.AutoSize = $true
$form.Controls.Add($hint)

$wifi = New-Object System.Windows.Forms.CheckBox
$wifi.Text = "Configuration actuelle — deux connexions Wi-Fi"
...
$wifiText.Text = "DTU sur son Wi-Fi propre : Wi-Fi interne vers la box + seconde antenne Wi-Fi vers le DTU."
...
$lan.Text = "Réseau unique — nano-routeur/LAN (recommandé)"
...
$lanText.Text = "DTU en Ethernet sur le nano-routeur Client/Pont ; ordinateur, Dinky et Shelly sur la box."
...
$continue.Location = New-Object System.Drawing.Point(445, 270)
...
$cancel.Location = New-Object System.Drawing.Point(575, 270)
