...
**Version 7.0.59 : lanceur Mac renforcé avec réparation automatique des autorisations.**
...
[![Version](https://img.shields.io/badge/version-7.0.59-2563eb)](RELEASE_NOTES_7.0.59.md)
...
La version 7.0.59 démarre la nouvelle interface web sur le port `8765`. Elle reprend les mesures déjà collectées par le logiciel : elle ne crée aucune connexion supplémentaire vers la DTU, le Dinky ou le Shelly.
