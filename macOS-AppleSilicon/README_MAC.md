# Boîte noire Hoymiles v7.0.31 — macOS Apple Silicon
...
- violet : production Shelly en trait mixte ;
- jaune : réseau EDF mesuré par le Shelly en pointillés renforcés ;
- rouge : réseau DDSU ;
...
Dans la moitié gauche du graphique elle s’ouvre vers la droite ; dans la moitié droite elle s’ouvre vers la gauche, afin de ne jamais sortir de l’écran.
