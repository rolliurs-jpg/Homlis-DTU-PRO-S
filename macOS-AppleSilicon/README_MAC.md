# Installation Mac — version 7.0.57
...
2. Ouvrez le dossier `Hoymiles-7.0.57-Mac`.
...
Le logiciel démarre un tableau mobile en lecture seule sur le port `8765`. Cliquez sur **Lecture à distance** pour afficher les adresses disponibles. Le navigateur s’ouvre après validation du message.
...
Dans Chrome ou Safari mobile, choisissez **Ajouter à l’écran d’accueil** pour obtenir une icône solaire ouvrant directement le tableau. Après une mise à jour, supprimez puis recréez les anciens raccourcis gris.
